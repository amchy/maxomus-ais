...
?>
      ...
      <form action="" method="get">
         ...
         <br />
         <input name="register" type="submit" class="btn-success" id="register" value="Register" />
         <input name="reset" type="reset" class="btn-danger" id="reset" value="Reset" />
      </form>
      </div>
      <div class="col-md-3">
         <img src="../images/icon_supplier_registration_gray.png" alt="" class="img-responsive"/>
      </div>
      </div>
